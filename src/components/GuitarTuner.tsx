  ...
  return (
    <div className="tuner-app">
      ...
      <div className="top-zone">
        ...
        {/* Big control button right under header */}
        <button
          ...
          <span>
            {isListening
              ? pitchData.isActive
                ? 'Signal détecté'
                : 'En écoute...'
              : 'Appuyez sur Accorder'}
          </span>
          {isListening && (
            <div className="volume-mini">
              <div
                className="volume-mini-fill"
                style={{
      ...
      {/* Middle zone: Pitch indicator (flexible) */}
      <div className="middle-zone">
        <PitchIndicator pitchData={pitchData} />
      </div>

      {/* Bottom zone: Headstock + String buttons */}
